...
import spring.master.path.entity.InfoCode;
import spring.master.path.entity.RespInfo;
import spring.master.path.utils.SaveFile;
...
public class Word2htmlController {
    @Value("${word.to.html.path}")// /tmp/qifei/doc/
    private String path;
    ...
    public String parseDocToHtml(MultipartFile file) throws IOException, ParserConfigurationException, TransformerException {
        ...
        wordToHtmlConverter.setPicturesManager(new PicturesManager() {
            public String savePicture(byte[] content, PictureType pictureType,
                ...
                return "E:\\tmp\\qifei\\doc" + suggestedName;
            }
        });
