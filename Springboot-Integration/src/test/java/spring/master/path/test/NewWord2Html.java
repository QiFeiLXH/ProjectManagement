 ...
 * @Author: QiFei
 * @CreateTime: 2019-10-14 14:01
 * @Description:
 */
public class NewWord2Html {
    /**
     * 回车符ASCII码
     */
    ...
    public void word2Html(){
        try {
            wordToHtml("C:\\Users\\Xuhui_Lin\\Desktop\\新建文件夹\\", "实习期工作内容.doc");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static void readPicture(PicturesTable pTable, CharacterRun cr) throws Exception {
        ...
        if (afileName.indexOf(".wmf") > 0) {
           /* OutputStream out = new FileOutputStream(new File(projectRealPath + directory + afileName));
            ...
            htmlText += "<img " + style + " src=\"C:\\Users\\Xuhui_Lin\\Desktop\\新建文件夹\\" + directory + afileName + "\"/>";
        }
        if (pic.getWidth() > 450) {
            htmlText += "<br/>";
        }
