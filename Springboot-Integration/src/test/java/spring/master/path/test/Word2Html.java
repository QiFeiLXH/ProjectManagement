 ...
 * @Author: QiFei
 * @CreateTime: 2019-10-14 10:42
 * @Description: 读取word并将word转换成html
 */
public class Word2Html {

    @Test
    public void word2Html() throws Exception {
        String filePath = "C:\\Users\\Xuhui_Lin\\Desktop\\新建文件夹\\实习期工作内容.doc";
        ...
        //for (File file2 : files) {
            ...
            if (file.getName().endsWith(".docx") || file.getName().endsWith(".DOCX")) {
                Word2Html.docx(filePath, file.getName(), name + ".htm");
            } else {
                Word2Html.dox(filePath, file.getName(), name + ".htm");
            }
       // }
    }
